  ...
  async function handleNext() {
    ...
    try {
      ...
      if (step === TOTAL_STEPS) {
        ...
        // Finalise the mentor row and mark onboarding complete.
        ...
        // Best-effort AI-generated bio (never blocks completion).
        ...
        // ?onboarded=1 bypasses the dashboard onboarding_completed guard on
        // its first render (see /dashboard loadData).
              ...
              <div>
                <FieldLabel optional>
                  ...
                  <span className="ml-1.5 text-white/30 font-normal text-xs">
                    shown on your public profile, helps mentees connect
                  </span>
                </FieldLabel>
                <div className="flex flex-wrap gap-2">
