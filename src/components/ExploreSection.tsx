...
export default function ExploreSection() {
  ...
  return (
    <section className="py-32 flex flex-col items-center justify-center overflow-hidden px-8 border-t border-white/5">
      {/* Header */}
      <div className="text-center mb-14">
        <p className="text-xs font-semibold text-[#A78BFA] uppercase tracking-[0.25em] mb-4">
          {t("explore_nav")}
        </p>
        <h2 className="text-6xl md:text-7xl lg:text-8xl font-extrabold text-white tracking-tight leading-none">
          {t("explore_title")}
        </h2>
      </div>
